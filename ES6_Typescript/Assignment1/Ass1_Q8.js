class Account {
  ...
  const account2 = new CurrentAccount(151860002537, "Ram", 25000, 10000);
  const account3 = new SavingAccount(151860002538, "Siva", 90000, 2000);
  const account4 = new CurrentAccount(151860002539, "Hanuman", 40000, 5000);
